                    ...
                    <div className="container">
                        <div className="small-card">
                            <div className="icon-container">
                                <img src={Quiz} className="icon-small" alt="Quiz Icon"></img>
                            </div>
                        ...
                        <div className="small-card">
                            <div className="icon-container">
                                <img src={Explore} className="icon-small" alt="Explore Icon"></img>
                            </div>
                            <div className="text-container">
                        ...
                        <div className="small-card">
                            <div className="icon-container">
                                <img src={Reward} className="icon-small" alt="Reward Icon"></img>
                            </div>
                            <div className="text-container">
                                Apply your items to your pet. Play all of the 16 mini games to get every item you can equip to your pet.
                            </div>
                        </div>
                    </div>
                </div>
